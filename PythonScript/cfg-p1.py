...
def main(argv) :
    ...
    functionName = "ecdh_data_dup"
    GFList = []

    GFList.append("ASN1_OCTET_STRING_new")
    GFList.append("ASN1_TYPE_free")
    GFList.append("ASN1_TYPE_new")
    GFList.append("BN_div")
    GFList.append("BN_get_flags")
    GFList.append("BN_is_zero")
    GFList.append("BN_mod_inverse_no_branch")
    GFList.append("BN_zero")
    GFList.append("BUFerr")
    GFList.append("CONFerr")
    GFList.append("CRYPTO_add")
    GFList.append("CRYPTO_r_unlock")
    GFList.append("CRYPTO_w_unlock")
    GFList.append("CTXDBG_ENTRY")
    GFList.append("CTXDBG_EXIT")
    GFList.append("CTXDBG_RET")
    GFList.append("EC_GFp_nistp224_method")
    GFList.append("EC_GFp_nistp256_method")
    GFList.append("EC_GFp_nistp521_method")
    GFList.append("ENGINEerr")
    GFList.append("GENERAL_NAME_new")
    GFList.append("HBITS")
    GFList.append("LBITS")
    GFList.append("M_ASN1_OCTET_STRING_set")
    GFList.append("OBJ_bsearch_ln")
    GFList.append("OBJ_bsearch_obj")
    GFList.append("OBJ_bsearch_sn")
    GFList.append("OBJ_bsearch_table")
    GFList.append("OPENSSL_realloc")
    GFList.append("OTHERNAME_new")
    GFList.append("RAND_add")
    GFList.append("RAND_bytes")
    GFList.append("X509V3_get_section")
    GFList.append("X509_NAME_ENTRY_dup")
    GFList.append("X509_NAME_ENTRY_free")
    GFList.append("X509_NAME_ENTRY_new")
    GFList.append("X509_NAME_free")
    GFList.append("X509_NAME_new")
    GFList.append("X509err")
    GFList.append("assert")
    GFList.append("bitstr_cb")
    GFList.append("bn_check_top")
    GFList.append("bn_correct_top")
    GFList.append("bn_expand")
    GFList.append("bn_wexpand")
    GFList.append("cb_new_ex_data")
    GFList.append("cpy_asc")
    GFList.append("cpy_bmp")
    GFList.append("cpy_univ")
    GFList.append("cpy_utf8")
    GFList.append("d2i_ASN1_TYPE")
    GFList.append("doapr_outch")
    GFList.append("ec_GFp_nist_field_mul")
    GFList.append("ec_GFp_nist_field_sqr")
    GFList.append("ec_GFp_nist_group_copy")
    GFList.append("ec_GFp_nist_group_set_curve")
    GFList.append("ec_GFp_simple_add")
    GFList.append("ec_GFp_simple_cmp")
    GFList.append("ec_GFp_simple_dbl")
    GFList.append("ec_GFp_simple_get_Jprojective_coordinates_GFp")
    GFList.append("ec_GFp_simple_group_check_discriminant")
    GFList.append("ec_GFp_simple_group_clear_finish")
    GFList.append("ec_GFp_simple_group_finish")
    GFList.append("ec_GFp_simple_group_get_curve")
    GFList.append("ec_GFp_simple_group_get_degree")
    GFList.append("ec_GFp_simple_group_init")
    GFList.append("ec_GFp_simple_invert")
    GFList.append("ec_GFp_simple_is_at_infinity")
    GFList.append("ec_GFp_simple_is_on_curve")
    GFList.append("ec_GFp_simple_make_affine")
    GFList.append("ec_GFp_simple_point_clear_finish")
    GFList.append("ec_GFp_simple_point_copy")
    GFList.append("ec_GFp_simple_point_finish")
    GFList.append("ec_GFp_simple_point_get_affine_coordinates")
    GFList.append("ec_GFp_simple_point_init")
    GFList.append("ec_GFp_simple_point_set_affine_coordinates")
    GFList.append("ec_GFp_simple_point_set_to_infinity")
    GFList.append("ec_GFp_simple_points_make_affine")
    GFList.append("ec_GFp_simple_set_Jprojective_coordinates_GFp")
    GFList.append("ec_pre_comp_clear_free")
    GFList.append("ec_pre_comp_dup")
    GFList.append("ec_pre_comp_free")
    GFList.append("ecdh_compute_key")
    GFList.append("ecdh_data_dup")
    GFList.append("engine_ref_debug")
    GFList.append("engine_table_select")
    GFList.append("fmtfp")
    GFList.append("fmtint")
    GFList.append("fmtstr")
    GFList.append("free_func")
    GFList.append("get_error_values")
    GFList.append("get_peerkey_low")
    GFList.append("handleErrors")
    GFList.append("i2d_ASN1_SEQUENCE_ANY")
    GFList.append("i2d_ASN1_SET_ANY")
    GFList.append("i2d_ASN1_TYPE")
    GFList.append("impl_check")
    GFList.append("in_utf8")
    GFList.append("ipv6_cb")
    GFList.append("lh_MEM_insert")
    GFList.append("lh_delete")
    GFList.append("lh_new")
    GFList.append("main")
    GFList.append("mem_cmp")
    GFList.append("mem_hash")
    GFList.append("mul")
    GFList.append("mul_add")
    GFList.append("out_utf8")
    GFList.append("sb_free_ex_data")
    GFList.append("sk_CONF_VALUE_num")
    GFList.append("sk_X509_NAME_ENTRY_insert")
    GFList.append("sk_X509_NAME_ENTRY_num")
    GFList.append("sk_new_null")
    GFList.append("sk_pop_free")
    GFList.append("ssleay_rand_seed")
    GFList.append("traverse_string")
    GFList.append("type_str")

    for functionname in GFList:
        recFuncSearch(path, functionname,".")
        
    #gVariable.append("NID_X9_62_prime_field")
    #gVariable.append("STACK")
    varSearch(path)
